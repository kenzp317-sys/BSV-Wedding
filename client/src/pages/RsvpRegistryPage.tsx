      ...
      <section className="relative overflow-hidden" style={{ height: 340 }}>
        ...
        <div className="absolute inset-0 flex items-center justify-center" style={{ background: "oklch(0.18 0.01 65 / 0.55)" }}>
          <div className="text-center px-6 max-w-xl">
            <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "clamp(1.3rem, 3.5vw, 2rem)", color: "white", lineHeight: 1.6, textShadow: "0 2px 12px rgba(0,0,0,0.4)" }}>
              We cannot wait to share this place, this food, and this light with the people we love most.
            </p>
            <p className="mt-4" style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "oklch(0.75 0.08 38)" }}>Damon & Mackenzie</p>
          </div>
        </div>
      </section>
      <section className="max-w-2xl mx-auto px-6 py-14 text-center">
        <AnimatedSection>
          ...
          <a href={ZOLA_URL} target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic", fontSize: "1.1rem", color: "oklch(0.45 0.04 65)", textDecoration: "none", borderBottom: "1px solid oklch(0.55 0.12 38)", paddingBottom: "2px" }}>zola.com/wedding/damon-mackenzie/registry</a>
        </AnimatedSection>
      </section>
      <Footer />
    </div>
